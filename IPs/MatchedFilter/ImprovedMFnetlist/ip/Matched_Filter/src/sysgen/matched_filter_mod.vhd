...
end matched_filter_stub;
architecture structural of matched_filter_stub is 
begin
  sysgen_dut : entity xil_defaultlib.Matched_Filter_0 
  port map (
