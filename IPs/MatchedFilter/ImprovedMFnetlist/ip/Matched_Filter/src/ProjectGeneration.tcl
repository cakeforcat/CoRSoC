...
namespace eval ::xilinx::dsp::planaheaddriver {
	...
	set IP_Name {Matched_Filter}
	set IP_Revision {374628944}
	set IP_Socket_IP {0}
	...
	set ProjectFiles {
		...
		{{vivado_ip.tcl}}
		{{matched_filter_dist_mem_gen_i0_vivado.coe}}
		{{matched_filter_entity_declarations.vhd} -lib {xil_defaultlib}}
		{{matched_filter.vhd} -lib {xil_defaultlib}}
		{{matched_filter_clock.xdc}}
		{{matched_filter.xdc}}
	}
	set SimPeriod 3.125e-08
	set SimTime 0.00025
	set SimulationTime {32204.00000000 ns}
	set SynthStrategyName {Vivado Synthesis Defaults}
	set SynthesisTool {Vivado}
	set TargetDir {C:/Users/jojok/Desktop/university/Project/ImprovedMFnetlist/ip/Matched_Filter/src}
	set TopLevelModule {matched_filter}
	set TopLevelSimulinkHandle 372
	...
	dict set TopLevelPortInterface s_axis_tvalid DatFile {matchedfilter2021updated_matched_filter_s_axis_tvalid.dat}
	...
	dict set TopLevelPortInterface s_axis_tvalid ClockDomain {matched_filter}
	...
	dict set TopLevelPortInterface s_axis_tuser DatFile {matchedfilter2021updated_matched_filter_s_axis_tuser.dat}
	...
	dict set TopLevelPortInterface s_axis_tuser ClockDomain {matched_filter}
	...
	dict set TopLevelPortInterface s_axis_tlast DatFile {matchedfilter2021updated_matched_filter_s_axis_tlast.dat}
	...
	dict set TopLevelPortInterface s_axis_tlast ClockDomain {matched_filter}
	...
	dict set TopLevelPortInterface s_axis_tdata DatFile {matchedfilter2021updated_matched_filter_s_axis_tdata.dat}
	...
	dict set TopLevelPortInterface s_axis_tdata ClockDomain {matched_filter}
	...
	dict set TopLevelPortInterface m_axis_tdata DatFile {matchedfilter2021updated_matched_filter_m_axis_tdata.dat}
	...
	dict set TopLevelPortInterface m_axis_tdata ClockDomain {matched_filter}
	...
	dict set TopLevelPortInterface m_axis_tlast DatFile {matchedfilter2021updated_matched_filter_m_axis_tlast.dat}
	...
	dict set TopLevelPortInterface m_axis_tlast ClockDomain {matched_filter}
	...
	dict set TopLevelPortInterface m_axis_tvalid DatFile {matchedfilter2021updated_matched_filter_m_axis_tvalid.dat}
	...
	dict set TopLevelPortInterface m_axis_tvalid ClockDomain {matched_filter}
	...
	dict set TopLevelPortInterface clk ClockDomain {matched_filter}
