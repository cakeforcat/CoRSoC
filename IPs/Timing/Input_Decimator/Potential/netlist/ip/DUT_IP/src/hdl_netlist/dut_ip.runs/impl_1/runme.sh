...
HD_PWD='C:/Users/andre/Year5/19520/IP/Input_Decimator/Potential/netlist/ip/DUT_IP/src/hdl_netlist/dut_ip.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log dut_ip.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source dut_ip.tcl -notrace
