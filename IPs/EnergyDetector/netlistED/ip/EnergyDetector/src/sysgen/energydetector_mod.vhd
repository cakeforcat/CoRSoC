...
end energydetector_stub;
architecture structural of energydetector_stub is 
begin
  sysgen_dut : entity xil_defaultlib.EnergyDetector_0 
  port map (
