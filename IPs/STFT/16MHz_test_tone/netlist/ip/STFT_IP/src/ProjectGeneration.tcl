...
namespace eval ::xilinx::dsp::planaheaddriver {
	...
	set SimTime 0.0192
	set SimulationTime {19400.06250000 ns}
	set SynthStrategyName {Vivado Synthesis Defaults}
	set SynthesisTool {Vivado}
	set TargetDir {C:/Users/andre/CoRSoC/IPs/STFT/16MHz/netlist/ip/STFT_IP/src}
	set TopLevelModule {stft_ip}
	set TopLevelSimulinkHandle 84.0004
	...
	dict set TopLevelPortInterface m_axis_tdata Type Fix_32_22
	dict set TopLevelPortInterface m_axis_tdata ArithmeticType xlSigned
	dict set TopLevelPortInterface m_axis_tdata BinaryPoint 22
