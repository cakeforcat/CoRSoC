...
module bd_36cd
  ...
  (* X_INTERFACE_INFO = "xilinx.com:interface:aximm:1.0 SLOT_1_AXI ARADDR" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME SLOT_1_AXI, ADDR_WIDTH 1, ARUSER_WIDTH 0, AWUSER_WIDTH 0, BUSER_WIDTH 0, CLK_DOMAIN design_1_zynq_ultra_ps_e_0_0_pl_clk0, DATA_WIDTH 32, FREQ_HZ 96968727, HAS_BRESP 1, HAS_BURST 0, HAS_CACHE 0, HAS_LOCK 0, HAS_PROT 1, HAS_QOS 0, HAS_REGION 0, HAS_RRESP 1, HAS_WSTRB 1, ID_WIDTH 0, INSERT_VIP 0, MAX_BURST_LENGTH 1, NUM_READ_OUTSTANDING 1, NUM_READ_THREADS 1, NUM_WRITE_OUTSTANDING 1, NUM_WRITE_THREADS 1, PHASE 0.0, PROTOCOL AXI4LITE, READ_WRITE_MODE READ_WRITE, RUSER_BITS_PER_BYTE 0, RUSER_WIDTH 0, SUPPORTS_NARROW_BURST 0, WUSER_BITS_PER_BYTE 0, WUSER_WIDTH 0" *) input [0:0]SLOT_1_AXI_araddr;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:interface:aximm:1.0 SLOT_1_AXI AWADDR" *) input [0:0]SLOT_1_AXI_awaddr;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:interface:aximm:1.0 SLOT_2_AXI ARADDR" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME SLOT_2_AXI, ADDR_WIDTH 10, ARUSER_WIDTH 0, AWUSER_WIDTH 0, BUSER_WIDTH 0, CLK_DOMAIN design_1_zynq_ultra_ps_e_0_0_pl_clk0, DATA_WIDTH 32, FREQ_HZ 96968727, HAS_BRESP 1, HAS_BURST 0, HAS_CACHE 0, HAS_LOCK 0, HAS_PROT 1, HAS_QOS 0, HAS_REGION 0, HAS_RRESP 1, HAS_WSTRB 1, ID_WIDTH 0, INSERT_VIP 0, MAX_BURST_LENGTH 1, NUM_READ_OUTSTANDING 2, NUM_READ_THREADS 1, NUM_WRITE_OUTSTANDING 2, NUM_WRITE_THREADS 1, PHASE 0.0, PROTOCOL AXI4LITE, READ_WRITE_MODE READ_WRITE, RUSER_BITS_PER_BYTE 0, RUSER_WIDTH 0, SUPPORTS_NARROW_BURST 0, WUSER_BITS_PER_BYTE 0, WUSER_WIDTH 0" *) input [9:0]SLOT_2_AXI_araddr;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:interface:axis:1.0 SLOT_4_AXIS TDATA" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME SLOT_4_AXIS, CLK_DOMAIN design_1_zynq_ultra_ps_e_0_0_pl_clk0, FREQ_HZ 96968727, HAS_TKEEP 0, HAS_TLAST 1, HAS_TREADY 0, HAS_TSTRB 0, INSERT_VIP 0, LAYERED_METADATA xilinx.com:interface:datatypes:1.0 {TDATA {datatype {name {attribs {resolve_type immediate dependency {} format string minimum {} maximum {}} value {}} bitwidth {attribs {resolve_type immediate dependency {} format long minimum {} maximum {}} value 16} bitoffset {attribs {resolve_type immediate dependency {} format long minimum {} maximum {}} value 0} real {fixed {fractwidth {attribs {resolve_type immediate dependency {} format long minimum {} maximum {}} value 15} signed {attribs {resolve_type immediate dependency {} format bool minimum {} maximum {}} value true}}}}}}, PHASE 0.0, TDATA_NUM_BYTES 2, TDEST_WIDTH 0, TID_WIDTH 0, TUSER_WIDTH 0" *) input [15:0]SLOT_4_AXIS_tdata;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.CLK CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.CLK, ASSOCIATED_BUSIF SLOT_0_AXI:SLOT_1_AXI:SLOT_2_AXI:SLOT_3_AXIS:SLOT_4_AXIS, ASSOCIATED_CLKEN aclken, ASSOCIATED_RESET resetn, CLK_DOMAIN design_1_zynq_ultra_ps_e_0_0_pl_clk0, FREQ_HZ 96968727, FREQ_TOLERANCE_HZ 0, INSERT_VIP 0, PHASE 0.0" *) input clk;
  ...
  wire [0:0]net_slot_1_axi_araddr;
  ...
  wire [0:0]net_slot_1_axi_awaddr;
  ...
  assign Conn4_TDATA = SLOT_4_AXIS_tdata[15:0];
  ...
  bd_36cd_ila_lib_0 ila_lib
       (.clk(clk_1),
        ...
        .probe17(net_slot_0_apc_pc_asserted),
        ...
        .probe36(net_slot_1_apc_pc_asserted),
        .probe37(net_slot_2_axi_ar_cnt),
        .probe38(net_slot_2_axi_araddr),
        .probe39(net_slot_2_axi_arprot),
        .probe4(net_slot_0_axi_awlen),
        .probe40(net_slot_2_axi_aw_cnt),
        .probe41(net_slot_2_axi_awaddr),
        .probe42(net_slot_2_axi_awprot),
        .probe43(net_slot_2_axi_b_cnt),
        .probe44(net_slot_2_axi_bresp),
        .probe45(net_slot_2_axi_r_cnt),
        .probe46(net_slot_2_axi_rdata),
        .probe47(net_slot_2_axi_rresp),
        ...
        .probe55(net_slot_2_apc_pc_asserted),
        .probe56(net_slot_3_axis_tdata),
        .probe57(net_slot_3_axis_tvalid),
        .probe58(net_slot_3_axis_tready),
        .probe59(net_slot_3_axis_tlast),
        .probe6(net_slot_0_axi_awsize),
        .probe60(net_slot_3_apc_pc_asserted),
        .probe61(net_slot_4_axis_tdata),
        .probe62(net_slot_4_axis_tvalid),
        .probe63(net_slot_4_axis_tlast),
        .probe64(net_slot_4_apc_pc_asserted),
        .probe7(net_slot_0_axi_b_cnt),
        .probe8(net_slot_0_axi_bresp),
        .probe9(net_slot_0_axi_r_cnt));
  bd_36cd_slot_0_apc_0 slot_0_apc
       (.aclk(clk_1),
        .aresetn(resetn_1),
        .pc_asserted(net_slot_0_apc_pc_asserted),
        .pc_axi_araddr(Conn_ARADDR),
        .pc_axi_arburst(Conn_ARBURST),
        .pc_axi_arcache(Conn_ARCACHE),
        .pc_axi_arlen(Conn_ARLEN),
        .pc_axi_arlock(Conn_ARLOCK),
        .pc_axi_arprot(Conn_ARPROT),
        .pc_axi_arqos(Conn_ARQOS),
        .pc_axi_arready(Conn_ARREADY),
        .pc_axi_arregion(Conn_ARREGION),
        .pc_axi_arsize(Conn_ARSIZE),
        .pc_axi_arvalid(Conn_ARVALID),
        .pc_axi_awaddr(Conn_AWADDR),
        .pc_axi_awburst(Conn_AWBURST),
        .pc_axi_awcache(Conn_AWCACHE),
        .pc_axi_awlen(Conn_AWLEN),
        .pc_axi_awlock(Conn_AWLOCK),
        .pc_axi_awprot(Conn_AWPROT),
        .pc_axi_awqos(Conn_AWQOS),
        .pc_axi_awready(Conn_AWREADY),
        .pc_axi_awregion(Conn_AWREGION),
        .pc_axi_awsize(Conn_AWSIZE),
        .pc_axi_awvalid(Conn_AWVALID),
        .pc_axi_bready(Conn_BREADY),
        .pc_axi_bresp(Conn_BRESP),
        .pc_axi_bvalid(Conn_BVALID),
        .pc_axi_rdata(Conn_RDATA),
        .pc_axi_rlast(Conn_RLAST),
        .pc_axi_rready(Conn_RREADY),
        .pc_axi_rresp(Conn_RRESP),
        .pc_axi_rvalid(Conn_RVALID),
        .pc_axi_wdata(Conn_WDATA),
        .pc_axi_wlast(Conn_WLAST),
        .pc_axi_wready(Conn_WREADY),
        .pc_axi_wstrb(Conn_WSTRB),
  ...
  bd_36cd_slot_1_apc_0 slot_1_apc
       (.aclk(clk_1),
        .aresetn(resetn_1),
  ...
  bd_36cd_slot_2_apc_0 slot_2_apc
       (.aclk(clk_1),
        .aresetn(resetn_1),
  ...
  bd_36cd_slot_3_apcs_0 slot_3_apcs
       (.aclk(clk_1),
        .aresetn(resetn_1),
  ...
  bd_36cd_slot_4_apcs_0 slot_4_apcs
       (.aclk(clk_1),
        .aresetn(resetn_1),
