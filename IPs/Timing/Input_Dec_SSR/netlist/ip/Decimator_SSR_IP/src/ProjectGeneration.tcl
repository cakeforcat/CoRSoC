...
namespace eval ::xilinx::dsp::planaheaddriver {
	...
	set TargetDir {C:/Users/andre/Year5/19520/IP/TiminP/Input_Dec_SSR/netlist/ip/Decimator_SSR_IP/src}
	set TopLevelModule {decimator_ssr_ip}
	set TopLevelSimulinkHandle 4.04761
	...
	dict set TopLevelPortInterface m_axis_im_tdata Type Fix_16_15
	dict set TopLevelPortInterface m_axis_im_tdata ArithmeticType xlSigned
	dict set TopLevelPortInterface m_axis_im_tdata BinaryPoint 15
	dict set TopLevelPortInterface m_axis_im_tdata Width 16
	dict set TopLevelPortInterface m_axis_im_tdata DatFile {decimator_ssr_decimator_ssr_ip_m_axis_im_tdata.dat}
	...
	dict set TopLevelPortInterface m_axis_im_tdata ClockDomain {decimator_ssr_ip}
	...
	dict set TopLevelPortInterface m_axis_re_tdata Type Fix_16_15
	dict set TopLevelPortInterface m_axis_re_tdata ArithmeticType xlSigned
	dict set TopLevelPortInterface m_axis_re_tdata BinaryPoint 15
	dict set TopLevelPortInterface m_axis_re_tdata Width 16
	dict set TopLevelPortInterface m_axis_re_tdata DatFile {decimator_ssr_decimator_ssr_ip_m_axis_re_tdata.dat}
	...
	dict set TopLevelPortInterface m_axis_re_tdata ClockDomain {decimator_ssr_ip}
