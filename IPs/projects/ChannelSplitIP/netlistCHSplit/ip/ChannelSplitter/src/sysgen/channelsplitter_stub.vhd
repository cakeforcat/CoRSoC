...
entity channelsplitter_stub is
  port (
...
end channelsplitter_stub;
architecture structural of channelsplitter_stub is 
begin
  sysgen_dut : entity xil_defaultlib.channelsplitter 
  port map (
