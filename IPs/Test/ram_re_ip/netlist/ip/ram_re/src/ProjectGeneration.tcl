...
namespace eval ::xilinx::dsp::planaheaddriver {
	...
	set ProjectFiles {
		...
		{{ram_re_entity_declarations.vhd} -lib {xil_defaultlib}}
		{{ram_re.vhd} -lib {xil_defaultlib}}
		{{ram_re_clock.xdc}}
		{{ram_re.xdc}}
	}
	set SimPeriod 1e-08
	set SimTime 0.0002
	set SimulationTime {400.01000000 ns}
	set SynthStrategyName {Vivado Synthesis Defaults}
	set SynthesisTool {Vivado}
	set TargetDir {C:/Users/andre/CoRSoC/IPs/Test/ram_re_ip/netlist/ip/ram_re/src}
	set TopLevelModule {ram_re}
	set TopLevelSimulinkHandle 12.0002
	set VHDLLib {xil_defaultlib}
	set TopLevelPortInterface {}
	dict set TopLevelPortInterface ctrl_ip Name {ctrl_ip}
	dict set TopLevelPortInterface ctrl_ip Type UFix_32_0
	dict set TopLevelPortInterface ctrl_ip ArithmeticType xlUnsigned
	dict set TopLevelPortInterface ctrl_ip BinaryPoint 0
	dict set TopLevelPortInterface ctrl_ip Width 32
	dict set TopLevelPortInterface ctrl_ip DatFile {ram_re_ip_ram_re_ctrl_ip.dat}
	dict set TopLevelPortInterface ctrl_ip IconText {ctrl_ip}
	dict set TopLevelPortInterface ctrl_ip Direction in
	dict set TopLevelPortInterface ctrl_ip Period 1
	dict set TopLevelPortInterface ctrl_ip Interface 0
	dict set TopLevelPortInterface ctrl_ip InterfaceName {}
	dict set TopLevelPortInterface ctrl_ip InterfaceString {DATA}
	dict set TopLevelPortInterface ctrl_ip ClockDomain {ram_re}
	dict set TopLevelPortInterface ctrl_ip Locs {}
	dict set TopLevelPortInterface ctrl_ip IOStandard {}
	...
	dict set TopLevelPortInterface m_axis_tdata DatFile {ram_re_ip_ram_re_m_axis_tdata.dat}
	...
	dict set TopLevelPortInterface m_axis_tdata ClockDomain {ram_re}
	...
	dict set TopLevelPortInterface m_axis_tlast DatFile {ram_re_ip_ram_re_m_axis_tlast.dat}
	...
	dict set TopLevelPortInterface m_axis_tlast ClockDomain {ram_re}
	...
	dict set TopLevelPortInterface m_axis_tvalid DatFile {ram_re_ip_ram_re_m_axis_tvalid.dat}
	...
	dict set TopLevelPortInterface m_axis_tvalid ClockDomain {ram_re}
	...
	dict set TopLevelPortInterface clk ClockDomain {ram_re}
