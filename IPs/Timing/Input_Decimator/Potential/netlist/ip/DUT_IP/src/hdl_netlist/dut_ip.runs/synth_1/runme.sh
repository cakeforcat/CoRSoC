...
HD_PWD='C:/Users/andre/Year5/19520/IP/Input_Decimator/Potential/netlist/ip/DUT_IP/src/hdl_netlist/dut_ip.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dut_ip.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dut_ip.tcl
