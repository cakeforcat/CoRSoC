-- Generated from Simulink block ram_re/ram_re_ip_struct
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity ram_re_ip_struct is
  port (
...
end ram_re_ip_struct;
architecture structural of ram_re_ip_struct is 
...
begin
  ...
  clk_net <= clk_1;
  ce_net <= ce_1;
  constant_x0 : entity xil_defaultlib.sysgen_constant_3f987cd935 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  convert : entity xil_defaultlib.ram_re_ip_xlconvert 
  generic map (
    bool_conversion => 0,
    din_arith => 2,
    din_bin_pt => 14,
  ...
  convert5 : entity xil_defaultlib.ram_re_ip_xlconvert 
  generic map (
    bool_conversion => 1,
    din_arith => 1,
    din_bin_pt => 0,
  ...
  counter : entity xil_defaultlib.ram_re_ip_xlcounter_limit 
  generic map (
    cnt_15_0 => 24,
    cnt_31_16 => 0,
    cnt_47_32 => 0,
    cnt_63_48 => 0,
    core_name0 => "ram_re_ip_c_counter_binary_v12_0_i0",
    count_limited => 1,
    op_arith => xlUnsigned,
    op_width => 5
  )
  ...
  rom : entity xil_defaultlib.ram_re_ip_xlsprom 
  generic map (
    c_address_width => 5,
    c_width => 16,
    latency => 1,
  ...
  relational : entity xil_defaultlib.sysgen_relational_7b581d1b32 
  port map (
    clr => '0',
    a => counter_op_net,
    b => constant_op_net,
  ...
  slice : entity xil_defaultlib.ram_re_ip_xlslice 
  generic map (
    new_lsb => 0,
    new_msb => 0,
    x_width => 32,
...
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity ram_re_ip_default_clock_driver is
  port (
    ram_re_ip_sysclk : in std_logic;
    ram_re_ip_sysce : in std_logic;
    ram_re_ip_sysclr : in std_logic;
    ram_re_ip_clk1 : out std_logic;
    ram_re_ip_ce1 : out std_logic
  );
end ram_re_ip_default_clock_driver;
architecture structural of ram_re_ip_default_clock_driver is 
begin
  ...
  port map (
    sysclk => ram_re_ip_sysclk,
    sysce => ram_re_ip_sysce,
    sysclr => ram_re_ip_sysclr,
    clk => ram_re_ip_clk1,
    ce => ram_re_ip_ce1
  );
end structural;
...
begin
  ...
  ram_re_ip_default_clock_driver : entity xil_defaultlib.ram_re_ip_default_clock_driver 
  port map (
    ram_re_ip_sysclk => clk_net,
    ram_re_ip_sysce => '1',
    ram_re_ip_sysclr => '0',
    ram_re_ip_clk1 => clk_1_net,
    ram_re_ip_ce1 => ce_1_net
  );
  ram_re_ip_struct : entity xil_defaultlib.ram_re_ip_struct 
  port map (
    ctrl_ip => ctrl_ip,
    clk_1 => clk_1_net,
    ce_1 => ce_1_net,
