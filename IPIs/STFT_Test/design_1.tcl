...
proc create_root_design { parentCell } {
  ...
  set_property -dict [list \
    ...
    CONFIG.DAC_NCO_Freq00 {3.8} \
    CONFIG.DAC_NCO_Freq01 {3.805} \
    CONFIG.DAC_NCO_Freq02 {3.810} \
    CONFIG.DAC_NCO_Freq03 {3.815} \
  ...
  # Create instance: proc_sys_reset_99M, and set properties
  set proc_sys_reset_99M [ create_bd_cell -type ip -vlnv xilinx.com:ip:proc_sys_reset:5.0 proc_sys_reset_99M ]
...
\
  ...
  # Create instance: STFT_0, and set properties
  set STFT_0 [ create_bd_cell -type ip -vlnv CoRSoC:VMC:STFT:1.0 STFT_0 ]

  # Create instance: Decimator_0, and set properties
  set Decimator_0 [ create_bd_cell -type ip -vlnv CoRSoC:VMC:Decimator:1.0 Decimator_0 ]

  # Create interface connections
  connect_bd_intf_net -intf_net Decimator_0_m_axis [get_bd_intf_pins Decimator_0/m_axis] [get_bd_intf_pins STFT_0/s_axis]
  connect_bd_intf_net -intf_net STFT_0_m_axis [get_bd_intf_pins STFT_0/m_axis] [get_bd_intf_pins axi_dma/S_AXIS_S2MM]
  ...
  connect_bd_intf_net -intf_net axi_interconnect_0_M01_AXI [get_bd_intf_pins axi_dma/S_AXI_LITE] [get_bd_intf_pins axi_interconnect_0/M01_AXI]
  ...
  connect_bd_intf_net -intf_net usp_rf_data_converter_0_m00_axis [get_bd_intf_pins Decimator_0/s_axis_re] [get_bd_intf_pins usp_rf_data_converter_0/m00_axis]
  connect_bd_intf_net -intf_net usp_rf_data_converter_0_m01_axis [get_bd_intf_pins Decimator_0/s_axis_im] [get_bd_intf_pins usp_rf_data_converter_0/m01_axis]
  ...
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_pins proc_sys_reset_99M/peripheral_aresetn] [get_bd_pins axi_interconnect_0/ARESETN] [get_bd_pins axi_interconnect_0/S00_ARESETN]
  connect_bd_net -net proc_sys_reset_1_peripheral_aresetn [get_bd_pins proc_sys_reset_adc0/peripheral_aresetn] [get_bd_pins usp_rf_data_converter_0/s_axi_aresetn] [get_bd_pins axi_interconnect_0/M00_ARESETN] [get_bd_pins system_ila_0/resetn] [get_bd_pins axi_interconnect_0/M01_ARESETN] [get_bd_pins axi_dma/axi_resetn] [get_bd_pins axi_smc/aresetn]
  connect_bd_net -net usp_rf_data_converter_0_clk_adc0 [get_bd_pins usp_rf_data_converter_0/clk_adc0] [get_bd_pins usp_rf_data_converter_0/m0_axis_aclk] [get_bd_pins usp_rf_data_converter_0/m1_axis_aclk] [get_bd_pins proc_sys_reset_adc0/slowest_sync_clk] [get_bd_pins usp_rf_data_converter_0/s_axi_aclk] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins system_ila_0/clk] [get_bd_pins zynq_ultra_ps_e_0/saxihp0_fpd_aclk] [get_bd_pins STFT_0/clk] [get_bd_pins Decimator_0/clk] [get_bd_pins axi_smc/aclk] [get_bd_pins axi_dma/s_axi_lite_aclk] [get_bd_pins axi_dma/m_axi_s2mm_aclk] [get_bd_pins axi_interconnect_0/M01_ACLK]
  connect_bd_net -net usp_rf_data_converter_0_clk_dac0 [get_bd_pins usp_rf_data_converter_0/clk_dac0] [get_bd_pins usp_rf_data_converter_0/s0_axis_aclk]
  connect_bd_net -net usp_rf_data_converter_0_m00_axis_tdata [get_bd_pins usp_rf_data_converter_0/m00_axis_tdata] [get_bd_pins Decimator_0/s_axis_re_tdata]
  connect_bd_net -net usp_rf_data_converter_0_m00_axis_tvalid [get_bd_pins usp_rf_data_converter_0/m00_axis_tvalid] [get_bd_pins Decimator_0/s_axis_re_tvalid]
  connect_bd_net -net usp_rf_data_converter_0_m01_axis_tdata [get_bd_pins usp_rf_data_converter_0/m01_axis_tdata] [get_bd_pins Decimator_0/s_axis_im_tdata]
  connect_bd_net -net usp_rf_data_converter_0_m01_axis_tvalid [get_bd_pins usp_rf_data_converter_0/m01_axis_tvalid] [get_bd_pins Decimator_0/s_axis_im_tvalid]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins zynq_ultra_ps_e_0/pl_clk0] [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins proc_sys_reset_99M/slowest_sync_clk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm1_fpd_aclk]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_resetn0 [get_bd_pins zynq_ultra_ps_e_0/pl_resetn0] [get_bd_pins proc_sys_reset_99M/ext_reset_in] [get_bd_pins proc_sys_reset_adc0/ext_reset_in]
