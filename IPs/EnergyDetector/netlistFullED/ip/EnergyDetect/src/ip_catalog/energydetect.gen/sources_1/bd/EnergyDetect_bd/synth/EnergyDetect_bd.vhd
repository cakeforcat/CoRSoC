...
--Date        : Sun Apr 13 03:25:46 2025
--Host        : DESKTOP-A4M58OC running 64-bit major release  (build 9200)
--Command     : generate_target EnergyDetect_bd.bd
--Design      : EnergyDetect_bd
...
entity EnergyDetect_bd is
  ...
  attribute CORE_GENERATION_INFO of EnergyDetect_bd : entity is "EnergyDetect_bd,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=EnergyDetect_bd,x_ipVersion=1.00.a,x_ipLanguage=VHDL,numBlks=1,numReposBlks=1,numNonXlnxBlks=1,numHierBlks=0,maxHierDepth=0,numSysgenBlks=1,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=SYSGEN,synth_mode=Hierarchical}";
  attribute HW_HANDOFF : string;
  attribute HW_HANDOFF of EnergyDetect_bd : entity is "EnergyDetect_bd.hwdef";
end EnergyDetect_bd;

architecture STRUCTURE of EnergyDetect_bd is
  component EnergyDetect_bd_EnergyDetect_1_0 is
  port (
    s_axis_tdata : in STD_LOGIC_VECTOR ( 15 downto 0 );
    s_axis_tdata2 : in STD_LOGIC_VECTOR ( 15 downto 0 );
    s_axis_tdata3 : in STD_LOGIC_VECTOR ( 15 downto 0 );
  ...
  end component EnergyDetect_bd_EnergyDetect_1_0;
  signal EnergyDetect_1_m_axis_TDATA : STD_LOGIC_VECTOR ( 31 downto 0 );
  signal EnergyDetect_1_m_axis_TLAST : STD_LOGIC_VECTOR ( 0 to 0 );
  signal EnergyDetect_1_m_axis_TVALID : STD_LOGIC_VECTOR ( 0 to 0 );
  ...
  attribute X_INTERFACE_INFO of s_axis_tdata8 : signal is "xilinx.com:signal:data:1.0 DATA.S_AXIS_TDATA8 DATA";
  attribute X_INTERFACE_PARAMETER of s_axis_tdata8 : signal is "XIL_INTERFACENAME DATA.S_AXIS_TDATA8, LAYERED_METADATA undef";
  attribute X_INTERFACE_INFO of s_axis_tlast : signal is "xilinx.com:interface:axis:1.0 s_axis TLAST";
  attribute X_INTERFACE_INFO of s_axis_tuser : signal is "xilinx.com:interface:axis:1.0 s_axis TUSER";
  attribute X_INTERFACE_INFO of s_axis_tvalid : signal is "xilinx.com:interface:axis:1.0 s_axis TVALID";
begin
  clk_1 <= clk;
  m_axis_tdata(31 downto 0) <= EnergyDetect_1_m_axis_TDATA(31 downto 0);
  m_axis_tlast(0) <= EnergyDetect_1_m_axis_TLAST(0);
  m_axis_tvalid(0) <= EnergyDetect_1_m_axis_TVALID(0);
  ...
  s_axis_tdata8_1(15 downto 0) <= s_axis_tdata8(15 downto 0);
EnergyDetect_1: component EnergyDetect_bd_EnergyDetect_1_0
     port map (
      clk => clk_1,
      m_axis_tdata(31 downto 0) => EnergyDetect_1_m_axis_TDATA(31 downto 0),
      m_axis_tlast(0) => EnergyDetect_1_m_axis_TLAST(0),
      ...
      s_axis_tdata8(15 downto 0) => s_axis_tdata8_1(15 downto 0),
