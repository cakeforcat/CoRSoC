...
namespace eval ::xilinx::dsp::planaheaddriver {
	...
	set IP_Name {EnergyDetect}
	set IP_Revision {375679151}
	set IP_Socket_IP {0}
	...
	set ProjectFiles {
		...
		{{vivado_ip.tcl}}
		{{energydetect_dist_mem_gen_i0_vivado.coe}}
		{{energydetect_entity_declarations.vhd} -lib {xil_defaultlib}}
		{{energydetect.vhd} -lib {xil_defaultlib}}
		{{energydetect_clock.xdc}}
		{{energydetect.xdc}}
	}
	...
	set TargetDir {C:/Users/jojok/Desktop/university/Project/TraditionalCognitiveIPs/ED_IP/netlistFullED/ip/EnergyDetect/src}
	set TopLevelModule {energydetect}
	set TopLevelSimulinkHandle 360
	...
	dict set TopLevelPortInterface s_axis_tvalid DatFile {fulled_energydetect_s_axis_tvalid.dat}
	...
	dict set TopLevelPortInterface s_axis_tvalid ClockDomain {energydetect}
	...
	dict set TopLevelPortInterface s_axis_tuser DatFile {fulled_energydetect_s_axis_tuser.dat}
	...
	dict set TopLevelPortInterface s_axis_tuser ClockDomain {energydetect}
	...
	dict set TopLevelPortInterface s_axis_tlast DatFile {fulled_energydetect_s_axis_tlast.dat}
	...
	dict set TopLevelPortInterface s_axis_tlast ClockDomain {energydetect}
	dict set TopLevelPortInterface s_axis_tlast Locs {}
	dict set TopLevelPortInterface s_axis_tlast IOStandard {}
	dict set TopLevelPortInterface s_axis_tdata8 Name {s_axis_tdata8}
	dict set TopLevelPortInterface s_axis_tdata8 Type Fix_16_14
	dict set TopLevelPortInterface s_axis_tdata8 ArithmeticType xlSigned
	dict set TopLevelPortInterface s_axis_tdata8 BinaryPoint 14
	dict set TopLevelPortInterface s_axis_tdata8 Width 16
	dict set TopLevelPortInterface s_axis_tdata8 DatFile {fulled_energydetect_s_axis_tdata8.dat}
	dict set TopLevelPortInterface s_axis_tdata8 IconText {s_axis_tdata8}
	dict set TopLevelPortInterface s_axis_tdata8 Direction in
	dict set TopLevelPortInterface s_axis_tdata8 Period 2
	dict set TopLevelPortInterface s_axis_tdata8 Interface 0
	dict set TopLevelPortInterface s_axis_tdata8 InterfaceName {}
	dict set TopLevelPortInterface s_axis_tdata8 InterfaceString {DATA}
	dict set TopLevelPortInterface s_axis_tdata8 ClockDomain {energydetect}
	dict set TopLevelPortInterface s_axis_tdata8 Locs {}
	dict set TopLevelPortInterface s_axis_tdata8 IOStandard {}
	...
	dict set TopLevelPortInterface s_axis_tdata7 DatFile {fulled_energydetect_s_axis_tdata7.dat}
	...
	dict set TopLevelPortInterface s_axis_tdata7 ClockDomain {energydetect}
	...
	dict set TopLevelPortInterface s_axis_tdata6 DatFile {fulled_energydetect_s_axis_tdata6.dat}
	...
	dict set TopLevelPortInterface s_axis_tdata6 ClockDomain {energydetect}
	...
	dict set TopLevelPortInterface s_axis_tdata5 DatFile {fulled_energydetect_s_axis_tdata5.dat}
	...
	dict set TopLevelPortInterface s_axis_tdata5 ClockDomain {energydetect}
	...
	dict set TopLevelPortInterface s_axis_tdata4 DatFile {fulled_energydetect_s_axis_tdata4.dat}
	...
	dict set TopLevelPortInterface s_axis_tdata4 ClockDomain {energydetect}
	...
	dict set TopLevelPortInterface s_axis_tdata3 DatFile {fulled_energydetect_s_axis_tdata3.dat}
	...
	dict set TopLevelPortInterface s_axis_tdata3 ClockDomain {energydetect}
	...
	dict set TopLevelPortInterface s_axis_tdata2 DatFile {fulled_energydetect_s_axis_tdata2.dat}
	...
	dict set TopLevelPortInterface s_axis_tdata2 ClockDomain {energydetect}
	...
	dict set TopLevelPortInterface s_axis_tdata DatFile {fulled_energydetect_s_axis_tdata.dat}
	...
	dict set TopLevelPortInterface s_axis_tdata ClockDomain {energydetect}
	...
	dict set TopLevelPortInterface m_axis_tdata DatFile {fulled_energydetect_m_axis_tdata.dat}
	...
	dict set TopLevelPortInterface m_axis_tdata ClockDomain {energydetect}
	...
	dict set TopLevelPortInterface m_axis_tlast DatFile {fulled_energydetect_m_axis_tlast.dat}
	...
	dict set TopLevelPortInterface m_axis_tlast ClockDomain {energydetect}
	...
	dict set TopLevelPortInterface m_axis_tvalid DatFile {fulled_energydetect_m_axis_tvalid.dat}
	...
	dict set TopLevelPortInterface m_axis_tvalid ClockDomain {energydetect}
	...
	dict set TopLevelPortInterface clk ClockDomain {energydetect}
