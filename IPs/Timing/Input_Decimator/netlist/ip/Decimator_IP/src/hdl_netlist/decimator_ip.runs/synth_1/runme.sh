...
HD_PWD='C:/Users/andre/Year5/19520/IP/TiminP/Input_Decimator/netlist/ip/Decimator_IP/src/hdl_netlist/decimator_ip.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log decimator_ip.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source decimator_ip.tcl
