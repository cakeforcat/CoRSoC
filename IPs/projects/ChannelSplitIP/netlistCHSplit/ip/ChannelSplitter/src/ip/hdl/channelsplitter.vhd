-- Generated from Simulink block ChannelSplit/ChannelSplitter_struct
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity channelsplitter_struct is
  port (
...
end channelsplitter_struct;
architecture structural of channelsplitter_struct is 
...
begin
  ...
  clk_net_x0 <= clk_2;
  ce_net_x0 <= ce_2;
  addsub : entity xil_defaultlib.channelsplitter_xladdsub 
  generic map (
    a_arith => xlSigned,
    a_bin_pt => 29,
    a_width => 32,
    ...
    c_latency => 1,
    c_output_width => 33,
    core_name0 => "channelsplitter_c_addsub_v12_0_i0",
    extra_registers => 0,
    full_s_arith => 2,
    full_s_width => 33,
    latency => 1,
  ...
  addsub1 : entity xil_defaultlib.channelsplitter_xladdsub 
  generic map (
    a_arith => xlSigned,
    a_bin_pt => 29,
    a_width => 32,
    ...
    c_latency => 1,
    c_output_width => 33,
    core_name0 => "channelsplitter_c_addsub_v12_0_i1",
    extra_registers => 0,
    full_s_arith => 2,
    full_s_width => 33,
    latency => 1,
  ...
  addsub2 : entity xil_defaultlib.channelsplitter_xladdsub 
  generic map (
    a_arith => xlSigned,
    a_bin_pt => 29,
    a_width => 32,
  ...
  addsub3 : entity xil_defaultlib.channelsplitter_xladdsub 
  generic map (
    a_arith => xlSigned,
    a_bin_pt => 29,
    a_width => 32,
  ...
  addsub4 : entity xil_defaultlib.channelsplitter_xladdsub 
  generic map (
    a_arith => xlSigned,
    a_bin_pt => 29,
    a_width => 32,
  ...
  addsub5 : entity xil_defaultlib.channelsplitter_xladdsub 
  generic map (
    a_arith => xlSigned,
    a_bin_pt => 29,
    a_width => 32,
  ...
  addsub6 : entity xil_defaultlib.channelsplitter_xladdsub 
  generic map (
    a_arith => xlSigned,
    a_bin_pt => 29,
    a_width => 32,
  ...
  addsub7 : entity xil_defaultlib.channelsplitter_xladdsub 
  generic map (
    a_arith => xlSigned,
    a_bin_pt => 29,
    a_width => 32,
  ...
  constant12 : entity xil_defaultlib.sysgen_constant_f3c07ce8c8 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  constant16 : entity xil_defaultlib.sysgen_constant_f3c07ce8c8 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  constant5 : entity xil_defaultlib.sysgen_constant_f3c07ce8c8 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  constant8 : entity xil_defaultlib.sysgen_constant_f3c07ce8c8 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  convert : entity xil_defaultlib.channelsplitter_xlconvert 
  generic map (
    bool_conversion => 0,
    din_arith => 2,
    din_bin_pt => 29,
  ...
  convert1 : entity xil_defaultlib.channelsplitter_xlconvert 
  generic map (
    bool_conversion => 0,
    din_arith => 2,
    din_bin_pt => 29,
  ...
  convert2 : entity xil_defaultlib.channelsplitter_xlconvert 
  generic map (
    bool_conversion => 0,
    din_arith => 2,
    din_bin_pt => 29,
  ...
  convert3 : entity xil_defaultlib.channelsplitter_xlconvert 
  generic map (
    bool_conversion => 0,
    din_arith => 2,
    din_bin_pt => 29,
  ...
  convert4 : entity xil_defaultlib.channelsplitter_xlconvert 
  generic map (
    bool_conversion => 0,
    din_arith => 2,
    din_bin_pt => 29,
  ...
  convert5 : entity xil_defaultlib.channelsplitter_xlconvert 
  generic map (
    bool_conversion => 0,
    din_arith => 2,
    din_bin_pt => 29,
  ...
  convert6 : entity xil_defaultlib.channelsplitter_xlconvert 
  generic map (
    bool_conversion => 0,
    din_arith => 2,
    din_bin_pt => 29,
  ...
  convert7 : entity xil_defaultlib.channelsplitter_xlconvert 
  generic map (
    bool_conversion => 0,
    din_arith => 2,
    din_bin_pt => 29,
  ...
  counter : entity xil_defaultlib.sysgen_counter_2389ad9d53 
  port map (
    clr => '0',
    clk => clk_net,
    ce => ce_net,
  ...
  counter2 : entity xil_defaultlib.sysgen_counter_2389ad9d53 
  port map (
    clr => '0',
    clk => clk_net,
    ce => ce_net,
  ...
  counter4 : entity xil_defaultlib.sysgen_counter_2389ad9d53 
  port map (
    clr => '0',
    clk => clk_net,
    ce => ce_net,
  ...
  counter6 : entity xil_defaultlib.sysgen_counter_2389ad9d53 
  port map (
    clr => '0',
    clk => clk_net,
    ce => ce_net,
  ...
  delay1 : entity xil_defaultlib.channelsplitter_xldelay 
  generic map (
    latency => 1,
    reg_retiming => 0,
    reset => 0,
  ...
  delay11 : entity xil_defaultlib.channelsplitter_xldelay 
  generic map (
    latency => 1,
    reg_retiming => 0,
    reset => 0,
  ...
  delay12 : entity xil_defaultlib.channelsplitter_xldelay 
  generic map (
    latency => 1,
    reg_retiming => 0,
    reset => 0,
  ...
  delay15 : entity xil_defaultlib.channelsplitter_xldelay 
  generic map (
    latency => 1,
    reg_retiming => 0,
    reset => 0,
  ...
  delay16 : entity xil_defaultlib.channelsplitter_xldelay 
  generic map (
    latency => 1,
    reg_retiming => 0,
    reset => 0,
  ...
  delay20 : entity xil_defaultlib.channelsplitter_xldelay 
  generic map (
    latency => 1,
    reg_retiming => 0,
    reset => 0,
  ...
  delay3 : entity xil_defaultlib.channelsplitter_xldelay 
  generic map (
    latency => 1,
    reg_retiming => 0,
    reset => 0,
  ...
  delay4 : entity xil_defaultlib.channelsplitter_xldelay 
  generic map (
    latency => 1,
    reg_retiming => 0,
    reset => 0,
  ...
  delay8 : entity xil_defaultlib.channelsplitter_xldelay 
  generic map (
    latency => 1,
    reg_retiming => 0,
    reset => 0,
  ...
  delay9 : entity xil_defaultlib.channelsplitter_xldelay 
  generic map (
    latency => 1,
    reg_retiming => 0,
    reset => 0,
  ...
  fir_compiler_7_1 : entity xil_defaultlib.xlfir_compiler_9b457268584d4f4f4656e8cff1ea0ea2 
  port map (
  ...
  fir_compiler_7_2 : entity xil_defaultlib.xlfir_compiler_6196f4c35a84a22f81ac7c5a03ce64e2 
  port map (
    s_axis_data_tdata_real => time_division_multiplexer_q_net,
    s_axis_config_tvalid => s_axis_tvalid_net(0),
    s_axis_config_tlast => relational1_op_net,
  ...
  fir_compiler_7_3 : entity xil_defaultlib.xlfir_compiler_08fdb5488bc2e331fb4c11f61310031c 
  port map (
  ...
  fir_compiler_7_4 : entity xil_defaultlib.xlfir_compiler_eb23b28261552107b57b2648687870e6 
  port map (
    s_axis_data_tdata_real => time_division_multiplexer1_q_net,
    s_axis_config_tvalid => s_axis_tvalid_net(0),
    s_axis_config_tlast => relational4_op_net,
  ...
  fir_compiler_7_5 : entity xil_defaultlib.xlfir_compiler_e2d7439cf39c0bf58873898d21b3945a 
  port map (
  ...
  fir_compiler_7_6 : entity xil_defaultlib.xlfir_compiler_edbf44fe7d5753eec783b58536cc5026 
  port map (
    s_axis_data_tdata_real => time_division_multiplexer2_q_net,
    s_axis_config_tvalid => s_axis_tvalid_net(0),
    s_axis_config_tlast => relational7_op_net,
  ...
  fir_compiler_7_7 : entity xil_defaultlib.xlfir_compiler_8aab7f25f632fcdfe64b9f22315e3471 
  port map (
  ...
  fir_compiler_7_8 : entity xil_defaultlib.xlfir_compiler_7832ac0853319c60e52299567541bce4 
  port map (
    s_axis_data_tdata_real => time_division_multiplexer3_q_net,
    s_axis_config_tvalid => s_axis_tvalid_net(0),
    s_axis_config_tlast => relational10_op_net,
  ...
  reinterpret1 : entity xil_defaultlib.sysgen_reinterpret_ce320b2cb2 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  reinterpret7 : entity xil_defaultlib.sysgen_reinterpret_ce320b2cb2 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  relational1 : entity xil_defaultlib.sysgen_relational_7f054b9f1e 
  port map (
    clr => '0',
    a => constant5_op_net,
    b => counter_op_net,
  ...
  relational10 : entity xil_defaultlib.sysgen_relational_7f054b9f1e 
  port map (
    clr => '0',
    a => constant16_op_net,
    b => counter6_op_net,
  ...
  relational4 : entity xil_defaultlib.sysgen_relational_7f054b9f1e 
  port map (
    clr => '0',
    a => constant8_op_net,
    b => counter2_op_net,
  ...
  relational7 : entity xil_defaultlib.sysgen_relational_7f054b9f1e 
  port map (
    clr => '0',
    a => constant12_op_net,
    b => counter4_op_net,
  ...
  time_division_demultiplexer : entity xil_defaultlib.channelsplitter_xltdd_multich 
  generic map (
    data_width => 32,
    frame_length => 2
  )
  ...
  time_division_demultiplexer1 : entity xil_defaultlib.channelsplitter_xltdd_multich 
  generic map (
    data_width => 32,
    frame_length => 2
  )
  ...
  time_division_demultiplexer2 : entity xil_defaultlib.channelsplitter_xltdd_multich 
  generic map (
    data_width => 32,
    frame_length => 2
  )
  ...
  time_division_demultiplexer3 : entity xil_defaultlib.channelsplitter_xltdd_multich 
  generic map (
    data_width => 32,
    frame_length => 2
  )
  ...
  time_division_demultiplexer4 : entity xil_defaultlib.channelsplitter_xltdd_multich 
  generic map (
    data_width => 32,
    frame_length => 2
  )
  ...
  time_division_demultiplexer5 : entity xil_defaultlib.channelsplitter_xltdd_multich 
  generic map (
    data_width => 32,
    frame_length => 2
  )
  ...
  time_division_demultiplexer6 : entity xil_defaultlib.channelsplitter_xltdd_multich 
  generic map (
    data_width => 32,
    frame_length => 2
  )
  ...
  time_division_demultiplexer7 : entity xil_defaultlib.channelsplitter_xltdd_multich 
  generic map (
    data_width => 32,
    frame_length => 2
  )
  ...
  time_division_multiplexer : entity xil_defaultlib.channelsplitter_xltdm 
  generic map (
    data_width => 16,
    hasValid => 0,
    num_inputs => 2
  ...
  time_division_multiplexer1 : entity xil_defaultlib.channelsplitter_xltdm 
  generic map (
    data_width => 16,
    hasValid => 0,
    num_inputs => 2
  ...
  time_division_multiplexer2 : entity xil_defaultlib.channelsplitter_xltdm 
  generic map (
    data_width => 16,
    hasValid => 0,
    num_inputs => 2
  ...
  time_division_multiplexer3 : entity xil_defaultlib.channelsplitter_xltdm 
  generic map (
    data_width => 16,
    hasValid => 0,
    num_inputs => 2
...
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity channelsplitter_default_clock_driver is
  port (
    channelsplitter_sysclk : in std_logic;
    channelsplitter_sysce : in std_logic;
    channelsplitter_sysclr : in std_logic;
    channelsplitter_clk1 : out std_logic;
    channelsplitter_ce1 : out std_logic;
    channelsplitter_clk2 : out std_logic;
    channelsplitter_ce2 : out std_logic
  );
end channelsplitter_default_clock_driver;
architecture structural of channelsplitter_default_clock_driver is 
begin
  ...
  port map (
    sysclk => channelsplitter_sysclk,
    sysce => channelsplitter_sysce,
    sysclr => channelsplitter_sysclr,
    clk => channelsplitter_clk1,
    ce => channelsplitter_ce1
  );
  ...
  port map (
    ...
    sysce => channelsplitter_sysce,
    sysclr => channelsplitter_sysclr,
    clk => channelsplitter_clk2,
    ce => channelsplitter_ce2
  );
end structural;
-- Generated from Simulink block 
library IEEE;
...
architecture structural of channelsplitter is 
  attribute core_generation_info : string;
  attribute core_generation_info of structural : architecture is "channelsplitter,sysgen_core_2024_1,{,compilation=IP Catalog,block_icon_display=Default,family=zynquplusRFSOC,part=xczu28dr,speed=-2-e,package=ffvg1517,synthesis_language=vhdl,hdl_library=xil_defaultlib,synthesis_strategy=Vivado Synthesis Defaults,implementation_strategy=Vivado Implementation Defaults,testbench=0,interface_doc=0,ce_clr=0,clock_period=0.0390625,system_simulink_period=1.95313e-08,waveform_viewer=0,axilite_interface=0,ip_catalog_plugin=0,hwcosim_burst_mode=0,simulation_time=0.000117187,addsub=8,constant=4,convert=8,counter=4,delay=10,fir_compiler_v7_2=8,reinterpret=2,relational=4,tdd=8,tdm=4,}";
  signal clk_1_net : std_logic;
  signal clk_2_net : std_logic;
  signal ce_2_net : std_logic;
  signal ce_1_net : std_logic;
begin
  channelsplitter_default_clock_driver : entity xil_defaultlib.channelsplitter_default_clock_driver 
  port map (
    channelsplitter_sysclk => clk,
    channelsplitter_sysce => '1',
    channelsplitter_sysclr => '0',
    channelsplitter_clk1 => clk_1_net,
    channelsplitter_ce1 => ce_1_net,
    channelsplitter_clk2 => clk_2_net,
    channelsplitter_ce2 => ce_2_net
  );
  channelsplitter_struct : entity xil_defaultlib.channelsplitter_struct 
  port map (
