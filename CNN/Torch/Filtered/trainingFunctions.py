...
def trainModel(buf, snr, epoch = 1):
   ...
   # Instantiate the model
    model = CNNModel( n_channels=n_channels, n_classes=n_classes)
   ...
   # Create DataLoader for training
    ...
    for epoch in range(num_epochs):
       ...
       print(f'Epoch {epoch+1}/{num_epochs}, Loss: {epoch_loss:.8f}, Accuracy: {epoch_accuracy:.8f}, Loss: {val_epoch_loss:.8}, Accuracy: {val_epoch_accuracy:.8}')
