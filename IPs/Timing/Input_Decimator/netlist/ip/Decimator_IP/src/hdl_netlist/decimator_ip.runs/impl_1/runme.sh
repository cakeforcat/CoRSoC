...
HD_PWD='C:/Users/andre/Year5/19520/IP/TiminP/Input_Decimator/netlist/ip/Decimator_IP/src/hdl_netlist/decimator_ip.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log decimator_ip.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source decimator_ip.tcl -notrace
