...
--Command     : generate_target FullMF_bd_wrapper.bd
--Design      : FullMF_bd_wrapper
...
end FullMF_bd_wrapper;

architecture STRUCTURE of FullMF_bd_wrapper is
  component FullMF_bd is
  port (
    clk : in STD_LOGIC;
    s_axis_tdata1 : in STD_LOGIC_VECTOR ( 15 downto 0 );
    s_axis_tdata2 : in STD_LOGIC_VECTOR ( 15 downto 0 );
  ...
  end component FullMF_bd;
begin
FullMF_bd_i: component FullMF_bd
     port map (
      clk => clk,
