...
namespace eval ::xilinx::dsp::planaheaddriver {
	...
	set IP_Name {acc_stream}
	set IP_Revision {370456683}
	set IP_Socket_IP {0}
	...
	set ProjectFiles {
		...
		{{vivado_ip.tcl}}
		{{acc_stream_ip_entity_declarations.vhd} -lib {xil_defaultlib}}
		{{acc_stream_ip.vhd} -lib {xil_defaultlib}}
		{{acc_stream_ip_clock.xdc}}
		{{acc_stream_ip.xdc}}
	}
	set SimPeriod 1
	set SimTime 1000
	set SimulationTime {1001000200.00000000 ns}
	set SynthStrategyName {Vivado Synthesis Defaults}
	set SynthesisTool {Vivado}
	set TargetDir {C:/Users/andre/CoRSoC/IPs/Source_Test/acc_stream_ip/netlist/ip/acc_stream_ip/src}
	set TopLevelModule {acc_stream_ip}
	set TopLevelSimulinkHandle 10127
	...
	dict set TopLevelPortInterface s_axis_tvalid DatFile {acc_stream_acc_stream_ip_s_axis_tvalid.dat}
	...
	dict set TopLevelPortInterface s_axis_tvalid ClockDomain {acc_stream_ip}
	...
	dict set TopLevelPortInterface s_axis_tuser DatFile {acc_stream_acc_stream_ip_s_axis_tuser.dat}
	...
	dict set TopLevelPortInterface s_axis_tuser ClockDomain {acc_stream_ip}
	...
	dict set TopLevelPortInterface s_axis_tlast DatFile {acc_stream_acc_stream_ip_s_axis_tlast.dat}
	...
	dict set TopLevelPortInterface s_axis_tlast ClockDomain {acc_stream_ip}
	...
	dict set TopLevelPortInterface s_axis_tdata DatFile {acc_stream_acc_stream_ip_s_axis_tdata.dat}
	...
	dict set TopLevelPortInterface s_axis_tdata ClockDomain {acc_stream_ip}
	...
	dict set TopLevelPortInterface m_axis_tready DatFile {acc_stream_acc_stream_ip_m_axis_tready.dat}
	...
	dict set TopLevelPortInterface m_axis_tready ClockDomain {acc_stream_ip}
	...
	dict set TopLevelPortInterface m_axis_tdata DatFile {acc_stream_acc_stream_ip_m_axis_tdata.dat}
	...
	dict set TopLevelPortInterface m_axis_tdata ClockDomain {acc_stream_ip}
	...
	dict set TopLevelPortInterface m_axis_tlast DatFile {acc_stream_acc_stream_ip_m_axis_tlast.dat}
	...
	dict set TopLevelPortInterface m_axis_tlast ClockDomain {acc_stream_ip}
	...
	dict set TopLevelPortInterface m_axis_tuser DatFile {acc_stream_acc_stream_ip_m_axis_tuser.dat}
	...
	dict set TopLevelPortInterface m_axis_tuser ClockDomain {acc_stream_ip}
	...
	dict set TopLevelPortInterface m_axis_tvalid DatFile {acc_stream_acc_stream_ip_m_axis_tvalid.dat}
	...
	dict set TopLevelPortInterface m_axis_tvalid ClockDomain {acc_stream_ip}
	...
	dict set TopLevelPortInterface s_axis_tready DatFile {acc_stream_acc_stream_ip_s_axis_tready.dat}
	...
	dict set TopLevelPortInterface s_axis_tready ClockDomain {acc_stream_ip}
	...
	dict set TopLevelPortInterface clk ClockDomain {acc_stream_ip}
