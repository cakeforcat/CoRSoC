...
entity dsp_stream_bd is
  ...
  attribute CORE_GENERATION_INFO of dsp_stream_bd : entity is "dsp_stream_bd,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=dsp_stream_bd,x_ipVersion=1.00.a,x_ipLanguage=VHDL,numBlks=1,numReposBlks=1,numNonXlnxBlks=1,numHierBlks=0,maxHierDepth=0,numSysgenBlks=1,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=SYSGEN,synth_mode=Hierarchical}";
  attribute HW_HANDOFF : string;
  attribute HW_HANDOFF of dsp_stream_bd : entity is "dsp_stream_bd.hwdef";
end dsp_stream_bd;

architecture STRUCTURE of dsp_stream_bd is
  component dsp_stream_bd_dsp_stream_1_0 is
  port (
    m_axis_tready : in STD_LOGIC_VECTOR ( 0 to 0 );
    s_axis_tdata : in STD_LOGIC_VECTOR ( 31 downto 0 );
    s_axis_tlast : in STD_LOGIC_VECTOR ( 0 to 0 );
  ...
  signal dsp_stream_1_m_axis_TVALID : STD_LOGIC_VECTOR ( 0 to 0 );
