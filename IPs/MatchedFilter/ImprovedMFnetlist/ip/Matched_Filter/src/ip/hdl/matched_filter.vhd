-- Generated from Simulink block Matchedfilter2021updated/Matched Filter_struct
library IEEE;
...
architecture structural of matched_filter_struct is 
  ...
  signal time_division_demultiplexer1_q0_net : std_logic_vector( 36-1 downto 0 );
  ...
  signal delay2_q_net : std_logic_vector( 37-1 downto 0 );
  ...
  signal time_division_demultiplexer1_q1_net : std_logic_vector( 36-1 downto 0 );
  signal addsub1_s_net : std_logic_vector( 37-1 downto 0 );
  signal delay3_q_net : std_logic_vector( 36-1 downto 0 );
  signal time_division_demultiplexer_q1_net : std_logic_vector( 36-1 downto 0 );
  ...
  signal time_division_demultiplexer_q0_net : std_logic_vector( 36-1 downto 0 );
...
begin
  ...
  constant5 : entity xil_defaultlib.sysgen_constant_6715929656 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  counter : entity xil_defaultlib.sysgen_counter_db4e5110f7 
  port map (
    clr => '0',
    clk => clk_net,
    ce => ce_net,
  ...
  delay2 : entity xil_defaultlib.matched_filter_xldelay 
  generic map (
    latency => 3,
    reg_retiming => 0,
    reset => 0,
  ...
  delay3 : entity xil_defaultlib.matched_filter_xldelay 
  generic map (
    latency => 1,
    reg_retiming => 0,
    reset => 0,
  ...
  fir_compiler_7_1 : entity xil_defaultlib.xlfir_compiler_2cf92fbe55f211e43895da4db39eb1b7 
  port map (
  ...
  fir_compiler_7_2 : entity xil_defaultlib.xlfir_compiler_d69d791022900d418e6ebe3cea3d2601 
  port map (
    s_axis_data_tdata_real => time_division_multiplexer_q_net,
    s_axis_config_tvalid => s_axis_tvalid_net(0),
    s_axis_config_tlast => relational1_op_net,
  ...
  relational1 : entity xil_defaultlib.sysgen_relational_46cef86050 
  port map (
    clr => '0',
    a => constant5_op_net,
    b => counter_op_net,
  ...
  time_division_demultiplexer : entity xil_defaultlib.matched_filter_xltdd_multich 
  generic map (
    data_width => 36,
    frame_length => 2
  )
  ...
  time_division_demultiplexer1 : entity xil_defaultlib.matched_filter_xltdd_multich 
  generic map (
    data_width => 36,
    frame_length => 2
  )
  ...
  time_division_multiplexer : entity xil_defaultlib.matched_filter_xltdm 
  generic map (
    data_width => 16,
    hasValid => 0,
    num_inputs => 2
...
entity matched_filter_default_clock_driver is
  port (
    ...
    matched_filter_clk2 : out std_logic;
    matched_filter_ce2 : out std_logic
  );
...
begin
  ...
  port map (
    ...
    sysce => matched_filter_sysce,
    sysclr => matched_filter_sysclr,
    clk => matched_filter_clk2,
    ce => matched_filter_ce2
  );
end structural;
-- Generated from Simulink block 
library IEEE;
...
architecture structural of matched_filter is 
  ...
  attribute core_generation_info of structural : architecture is "matched_filter,sysgen_core_2024_1,{,compilation=IP Catalog,block_icon_display=Default,family=zynquplusRFSOC,part=xczu28dr,speed=-2-e,package=ffvg1517,synthesis_language=vhdl,hdl_library=xil_defaultlib,synthesis_strategy=Vivado Synthesis Defaults,implementation_strategy=Vivado Implementation Defaults,testbench=0,interface_doc=0,ce_clr=0,clock_period=4,system_simulink_period=3.125e-08,waveform_viewer=0,axilite_interface=0,ip_catalog_plugin=0,hwcosim_burst_mode=0,simulation_time=0.00025,addsub=2,constant=4,convert=1,cordic_v6_0=1,counter=2,delay=5,fir_compiler_v7_2=2,mult=1,multadd=1,reinterpret=3,relational=3,slice=4,spram=1,tdd=2,tdm=1,}";
...
begin
  ...
  port map (
    ...
    matched_filter_clk2 => clk_2_net,
    matched_filter_ce2 => ce_2_net
  );
