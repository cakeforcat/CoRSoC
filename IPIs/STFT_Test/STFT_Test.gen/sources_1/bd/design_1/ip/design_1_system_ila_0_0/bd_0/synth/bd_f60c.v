...
module bd_f60c
  ...
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.CLK CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.CLK, ASSOCIATED_BUSIF SLOT_0_AXI:SLOT_1_AXI, ASSOCIATED_RESET resetn, CLK_DOMAIN design_1_usp_rf_data_converter_0_0_clk_adc0, FREQ_HZ 64000000, FREQ_TOLERANCE_HZ 0, INSERT_VIP 0, PHASE 0.0" *) input clk;
  ...
  bd_f60c_ila_lib_0 ila_lib
       (.clk(clk_1),
        ...
        .probe32(net_slot_1_axi_ar_cnt),
        .probe33(net_slot_1_axi_araddr),
        .probe34(net_slot_1_axi_arburst),
        .probe35(net_slot_1_axi_arcache),
        .probe36(net_slot_1_axi_arlen),
        .probe37(net_slot_1_axi_arlock),
        .probe38(net_slot_1_axi_arprot),
        .probe39(net_slot_1_axi_arqos),
        .probe4(net_slot_0_axi_arlen),
        .probe40(net_slot_1_axi_arregion),
        .probe41(net_slot_1_axi_arsize),
        .probe42(net_slot_1_axi_aw_cnt),
        .probe43(net_slot_1_axi_awaddr),
        .probe44(net_slot_1_axi_awburst),
        .probe45(net_slot_1_axi_awcache),
        ...
        .probe50(net_slot_1_axi_awregion),
