...
--Date        : Fri Mar  7 13:43:57 2025
--Host        : DESKTOP-A4M58OC running 64-bit major release  (build 9200)
--Command     : generate_target EnergyDetector_bd.bd
--Design      : EnergyDetector_bd
...
entity EnergyDetector_bd is
  ...
  attribute CORE_GENERATION_INFO of EnergyDetector_bd : entity is "EnergyDetector_bd,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=EnergyDetector_bd,x_ipVersion=1.00.a,x_ipLanguage=VHDL,numBlks=1,numReposBlks=1,numNonXlnxBlks=1,numHierBlks=0,maxHierDepth=0,numSysgenBlks=1,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=SYSGEN,synth_mode=Hierarchical}";
  attribute HW_HANDOFF : string;
  attribute HW_HANDOFF of EnergyDetector_bd : entity is "EnergyDetector_bd.hwdef";
end EnergyDetector_bd;

architecture STRUCTURE of EnergyDetector_bd is
  component EnergyDetector_bd_EnergyDetector_1_0 is
  port (
    s_axis_tdata : in STD_LOGIC_VECTOR ( 31 downto 0 );
    s_axis_tlast : in STD_LOGIC_VECTOR ( 0 to 0 );
    s_axis_tuser : in STD_LOGIC_VECTOR ( 31 downto 0 );
  ...
  end component EnergyDetector_bd_EnergyDetector_1_0;
  signal EnergyDetector_1_m_axis_TDATA : STD_LOGIC_VECTOR ( 31 downto 0 );
  signal EnergyDetector_1_m_axis_TLAST : STD_LOGIC_VECTOR ( 0 to 0 );
  signal EnergyDetector_1_m_axis_TVALID : STD_LOGIC_VECTOR ( 0 to 0 );
...
EnergyDetector_1: component EnergyDetector_bd_EnergyDetector_1_0
     port map (
      clk => clk_1,
      m_axis_tdata(31 downto 0) => EnergyDetector_1_m_axis_TDATA(31 downto 0),
      m_axis_tlast(0) => EnergyDetector_1_m_axis_TLAST(0),
